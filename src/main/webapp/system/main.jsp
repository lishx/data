...
<c:set var="skinName" value="skin"></c:set>
<c:set var="themeColor" value="blue"></c:set>
<title>QUI网页界面集成框架JAVA示例版</title>
<!--框架必需start-->
<link href="${path}/libs/css/import_basic.css" rel="stylesheet" type="text/css"/>
<link href="${path}/libs/skins/${themeColor }/style.css" rel="stylesheet" type="text/css" id="theme"  themeColor="${themeColor }" positionTarget="positionContent"/>
<link href="${path}/system/${skinName }/style.css" rel="stylesheet" 
type="text/css" id="skin"  skinPath="system/${skinName }/"/>
...
function changeSkin(themeColor,skinName){
	top.Dialog.confirm("确定应用该皮肤吗？",function(){
		document.getElementById("sessionSkin").src="${path}/sys/skin.jsp?skinName="+skinName+"&themeColor="+themeColor;
	})
}
$(function(){
	if(broswerFlag!="IE6"){
...
<!-- 				<span class="icon_lock hand" onclick="lockScreen()">系统锁屏</span> -->
				<span class="icon_exit hand" onclick='top.Dialog.confirm("确定要退出系统吗",function(){window.location="${path}/logout"});'>退出系统</span>
			</div>
			<div class="clear"></div>
		</div>
	</div>
    ...
    <div position="left">
			<div id="lbox">
				...
				<div id="lbox_middleright">
						...
						<iframe height="100%" width="100%"  frameBorder=0 id=frmleft 
						name=frmleft src="${path }/system/left.jsp"  allowTransparency="true"></iframe>
						</div>
			...
			<div id="rbox">
				...
				<div id="rbox_middleright">
					<div id="bs_right">
					       ...
					       id=frmright name=frmright src="${path }/system/open.jsp"  allowTransparency="true"></iframe>
					</div>
				</div>
				</div>
				</div>
